...
use Genv\Otc\Utils\Path;
use Illuminate\Console\Command;
use Illuminate\Contracts\Foundation\Application as ApplicationContract;

class DevPackageHandler extends \Genv\Otc\Support\PackageHandler
{
    /**
    ...
    public function makeMigrationHandle(Command $command)
    {
        ...
        $path = Path::relative(
            $this->app->basePath(),
            $this->app->make('path.web.migrations')
        );
    ...
    {
        $path = $this->app->make('path.web.seeds');
        ...
        $content = file_get_contents(
            $this->app->make('path.web.resources').'/stubs/seeder'
        );
    ...
    public function makeModelHandle(Command $command)
    {
        ...
        $content = file_get_contents(
            $this->app->make('path.web.resources').'/stubs/model'
        );
        $variable = [
            '{--name--}' => $modelName,
            '{--table-name--}' => $table,

...
const isRepositorie = !!parseInt(process.env.GENV_DEV || 0);
...
const src = path.join(__dirname, 'resources/assets/js');
...
const webpackConfig = {
    ...
    */
    ...
    output: {
        path: isRepositorie ? path.join(__dirname, '../../../../public/web') : path.join(__dirname, 'assets'),
        filename: '[name].js'
    },

...
<div class="flex-center position-ref full-height g-bg-color">
    <div class="content">
        ...
        <div class="title m-b-md">
            The plus-id Package For genvotc+
        </div>

        <div class="links">
            <a href="https://github.com/genv/genvotc-plus/tree/master/docs">Documentation</a>
            <a href="https://github.com/genv/genvotc-plus">GitHub</a>
        </div>
    </div>
</div>

...
class SiteController extends Controller
{
     ...
     *
     * @var Genv\Otc\Models\CommonConfig
     */
    ...
    public function get(Request $request, Repository $config, ResponseFactory $response)
    {
        ...
        $name = $config->get('app.name', 'genvotc+');
    ...
    private function initSiteConfiguration(Configuration $configuration)
    {
        ...
        $config->set('site.user_invite_template', '我发现了一个全平台社交系统genvotc+，快来加入吧：http://t.cn/RpFfbbi');
